...
abstract class Service
{
     ...
     * 可执行like的字段白名单
     */
    protected $likeWhiteList = ['barcode', 'name', 'keyword', 'telephone', 'mobile', 'email', 'app_id', 'task'];
    ...
    private function processRelativeFilterParam(Builder $builder, $relation, $key, $value) {
        ...
        if (method_exists($model, 'isInQueryWhiteList')
            && $model->isInQueryWhiteList($fieldName, $relation))
        {
